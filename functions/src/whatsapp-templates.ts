...
export type TemplateKey = 'appointmentApproved' | 'appointmentRescheduled' | 'appointmentCancelled' | 'appointmentReminder24h' | 'appointmentBookedByAdmin';
...
const templates: Record<TemplateKey, string> = {
    ...
    appointmentBookedByAdmin: "✨נקבע לך תור חדש!✨\nהיי #clientName#, נקבע לך תור עבור #serviceName# בתאריך #date# בשעה #time#.\nמצפים לראותך!\n\nיסמין - לגלות את היופי שבך\nרחוב ברנר 7, רחובות",
};
